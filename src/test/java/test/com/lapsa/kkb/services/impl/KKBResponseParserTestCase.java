...
public class KKBResponseParserTestCase extends ArquillianBaseTestCase {
    ...
    private static final String PARSE_ORDER_ID_FAILED_ORDER_ID = "484902574738032";

    @Test(expected = KKBFormatException.class)
    public void testParseOrderId_Failed() throws KKBServiceError, KKBFormatException {
	String orderId = responseParserService.parseOrderId(PARSE_ORDER_ID_FAILED_RESPONSE);
	assertThat(orderId, allOf(not(nullValue()), is(PARSE_ORDER_ID_FAILED_ORDER_ID)));
    }
}
